...
filepattern = fullfile(datafolder, 'sub-47*_szcontrol_eeg_clean.set');
filepattern2 = fullfile(datafolder, 'sub-48*_szcontrol_eeg_clean.set');

% directory of data files
datafiles = [dir(filepattern); dir(filepattern2)];

% cell array to store coherence and psd 
coh_psd_ctrl_8 = cell(length(datafiles), 2);
